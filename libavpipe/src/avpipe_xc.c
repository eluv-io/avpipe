    ...
    int do_instrument)
{
    ...
    if ((rc = prepare_decoder(&xctx->decoder_ctx, in_handlers, inctx, params,
        params->seekable, params->bypass_transcoding, 1)) != eav_success) {
    ...
    int *n_streams)
{
    ...
    if ((rc = prepare_decoder(&decoder_ctx, in_handlers, &inctx, params,
        params->seekable, 1, 0)) != eav_success) {
