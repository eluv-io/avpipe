...
)
{
    printf(
        ...
        "\t-level:                  (optional) Encoding level for video, as the codec's level_idc (the value probe reports):\n"
        "\t                         H.264 is 10x the level number (41 for 4.1), HEVC is 30x (123 for 4.1). If it is not\n"
        "\t                         determined, it will be set automatically. Applies to libx264 and libx265.\n"
